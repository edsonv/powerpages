...
<div class="d-flex">
    <h1 class="h3"><i class="fa fa-xs fa-wrench text-gray-700"></i> <?= $this->language->admin_settings->header ?></h1>
</div>
                ...
                <form action="" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="main">
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-atlas text-muted"></i> <?= $this->language->admin_settings->main->default_timezone ?></label>
                        ...
                        <div class="tab-pane fade" id="payment">
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-credit-card text-muted"></i> <?= $this->language->admin_settings->payment->type ?></label>
                        ...
                        <div class="tab-pane fade" id="instagram">
                            <div class="form-group">
                                ...
                                <select name="instagram_is_enabled" class="form-control">
