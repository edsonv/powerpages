...
<div class="d-flex justify-content-between">
    <h1 class="h3"><i class="fa fa-xs fa-book text-gray-700"></i> <?= $this->language->admin_pages_categories->header ?></h1>

    <div class="col-auto">
        <a href="<?= url('admin/pages-category-create') ?>" class="btn btn-primary rounded-pill"><i class="fa fa-plus-circle"></i> <?= $this->language->admin_pages_categories->create ?></a>
    </div>
</div>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column">
                            <span><?= $row->title ?></span>
                            <span><a href="<?= url('pages/' . $row->url) ?>" class="text-muted"><?= $row->url ?></a></span>
                        </div>
                    </div>
                </td>
                <td class="text-muted">
                    <i class="fa fa-sm fa-file-alt"></i> <?= sprintf($this->language->admin_pages_categories->pages_categories->total_pages, $row->total_pages) ?>
                </td>
...
<div class="d-flex justify-content-between">
    <h1 class="h3"><i class="fa fa-xs fa-file-alt text-gray-700"></i> <?= $this->language->admin_pages->header ?></h1>

    <div class="col-auto">
        <a href="<?= url('admin/page-create') ?>" class="btn btn-primary rounded-pill"><i class="fa fa-plus-circle"></i> <?= $this->language->admin_pages->create ?></a>
    </div>
</div>
