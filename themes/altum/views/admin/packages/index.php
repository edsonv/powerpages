...
<div class="d-flex justify-content-between">
    <h1 class="h3"><i class="fa fa-xs fa-box-open text-gray-700"></i> <?= $this->language->admin_packages->header ?></h1>

    <div class="col-auto p-0">
        <a href="<?= url('admin/package-create') ?>" class="btn btn-primary rounded-pill"><i class="fa fa-plus-circle"></i> <?= $this->language->admin_packages->create ?></a>
    </div>
</div>
